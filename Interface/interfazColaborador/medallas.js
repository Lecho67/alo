  ...
  const page = `<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <title>Plan Carrera - Logros</title>
      ...
      <body>
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="/mislogros" class="active"><img class="icon" src="/images/Insignias.png" alt="">Logros</a></li>
                ...
                <div class=" templatemo-content-widget white-bg templatemo-overflow-hidden">
                  <div class="templatemo-flex-row flex-content-row">
                    <div class="" style="width:200px">
                      ...
                      <h2>Nombre: Logro Generico </h2><hr>
                      <br>
                      <p>Estado: </p>
                      <br>
                      <p>Descripción: No hay</p> 
                    </div>
                  </div>
                </div>
                  ...
                  <div class="templatemo-flex-row flex-content-row">
                    <div class="col-1" style="text-align: center;">
                      <ul class="button-list">
                        <li><h2 class="bold">Puntos de logro: ------</h2></li>
                        <li><a href="" class="templatemo-add-btn">Agregar al perfil</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <form action="/CrearMedalla" method="POST" enctype="multipart/form-data">
                      <details>
                          ...
                          <div class="templatemo-content-widget light-gray-bg" style="width: 30%; display: grid; align-items: center">
                              ...
                              <input type="text" name="nombre" id="nombre" placeholder="Nombre de la insignia" maxlength="50"><br>
                              <label for="Descripcion">Descripción: </label>
                              <input type="text" name="descripcion" id="Descripcion" placeholder="Inserte Una Descripción" maxlength="400"><br><br>
              ...
              <summary>
                ...
                <div class="templatemo-content-widget>
                  <br>
                    <div class="templatemo-content-widget light-gray-bg" style="width: 30%; display: grid; align-items: center">
                      <label for="nombre">Nombre: </label>
                      <input type="text" name="nombre" id="nombre" placeholder="Nombre de la insignia" maxlenght="50"><br>
                      <label for="descripcion">Descripción: </label>
                      <input type="text" name="descripcion" id="descripcion" placeholder="Inserte Una Descripción" maxlenght="400"><br><br>
                      <label for="file">Foto de la insignia: </label>
                      <input type="file" name="file" id="file" accept="image/*"><br>
                      <input type="submit" class="ajustar-actulizar"value="Crear Nueva Insignia">
                    </div>
